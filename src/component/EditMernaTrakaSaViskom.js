...
const EditMernaTrakaSaViskom = ({ id }) => {
    ...
    useEffect(() => {
        ...
        const fetchMerilo = async () => {
            const urlMerilo = `${globalVariable}/api/v1/mernaTrakaSaViskom/get?brojZapisnika=${id}`;
    ...
    const handleSubmit = (event) => {
        ...
        const endpoint = `${globalVariable}/api/v1/mernaTrakaSaViskom/update/` + replacedString;

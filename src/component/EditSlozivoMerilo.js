...
const EditSlozivoMerilo = ({ id }) => {
    ...
    useEffect(() => {
        ...
        const fetchMerilo = async () => {
            const urlMerilo = `http://localhost:8080/api/v1/slozivoMerilo/get?brojZapisnika=${id}`;
    ...
    const handleSubmit = (event) => {
        ...
        const endpoint = 'http://localhost:8080/api/v1/slozivoMerilo/update/' + replacedString;
...
export default EditSlozivoMerilo;
